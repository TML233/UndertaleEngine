...
if(STATE==BATTLE_STATE.TURN_PREPARATION){
	...
	var MOVE_TWEEN=Battle_GetTurnInfo(BATTLE_TURN.BOARD_MOVE_TWEEN,GMU_ANIM.LINEAR);
	var MOVE_EASE=Battle_GetTurnInfo(BATTLE_TURN.BOARD_MOVE_EASE,GMU_ANIM.OUT);
	...
	var SIZE_TWEEN=Battle_GetTurnInfo(BATTLE_TURN.BOARD_SIZE_TWEEN,GMU_ANIM.LINEAR);
	var SIZE_EASE=Battle_GetTurnInfo(BATTLE_TURN.BOARD_SIZE_EASE,GMU_ANIM.OUT);
	...
	if(MOVE_MODE==BATTLE_TURN_BOARD_TRANSFORM_MODE.SPEED){
		Anim_New(battle_board,"x",MOVE_TWEEN,MOVE_EASE,X_OLD,X_CHANGE,round(abs(X_CHANGE/MOVE_SPEED)));
		Anim_New(battle_board,"y",MOVE_TWEEN,MOVE_EASE,Y_OLD,Y_CHANGE,round(abs(Y_CHANGE/MOVE_SPEED)));
	}else{
		Anim_New(battle_board,"x",MOVE_TWEEN,MOVE_EASE,X_OLD,X_CHANGE,MOVE_DURATION);
		Anim_New(battle_board,"y",MOVE_TWEEN,MOVE_EASE,Y_OLD,Y_CHANGE,MOVE_DURATION);
	}
	if(SIZE_MODE==BATTLE_TURN_BOARD_TRANSFORM_MODE.SPEED){
		Anim_New(battle_board,"up",SIZE_TWEEN,SIZE_EASE,UP_OLD,UP_CHANGE,round(abs(UP_CHANGE/SIZE_SPEED)));
		Anim_New(battle_board,"down",SIZE_TWEEN,SIZE_EASE,DOWN_OLD,DOWN_CHANGE,round(abs(DOWN_CHANGE/SIZE_SPEED)));
		Anim_New(battle_board,"left",SIZE_TWEEN,SIZE_EASE,LEFT_OLD,LEFT_CHANGE,round(abs(LEFT_CHANGE/SIZE_SPEED)));
		Anim_New(battle_board,"right",SIZE_TWEEN,SIZE_EASE,RIGHT_OLD,RIGHT_CHANGE,round(abs(RIGHT_CHANGE/SIZE_SPEED)));
	}else{
		Anim_New(battle_board,"up",SIZE_TWEEN,SIZE_EASE,UP_OLD,UP_CHANGE,SIZE_DURATION);
		Anim_New(battle_board,"down",SIZE_TWEEN,SIZE_EASE,DOWN_OLD,DOWN_CHANGE,SIZE_DURATION);
		Anim_New(battle_board,"left",SIZE_TWEEN,SIZE_EASE,LEFT_OLD,LEFT_CHANGE,SIZE_DURATION);
		Anim_New(battle_board,"right",SIZE_TWEEN,SIZE_EASE,RIGHT_OLD,RIGHT_CHANGE,SIZE_DURATION);
	}
}
...
if(STATE==BATTLE_STATE.BOARD_RESETTING){
	...
	var MOVE_TWEEN=Battle_GetTurnInfo(BATTLE_TURN.BOARD_RESET_MOVE_TWEEN,GMU_ANIM.LINEAR);
	var MOVE_EASE=Battle_GetTurnInfo(BATTLE_TURN.BOARD_RESET_MOVE_EASE,GMU_ANIM.OUT);
	...
	var SIZE_TWEEN=Battle_GetTurnInfo(BATTLE_TURN.BOARD_RESET_SIZE_TWEEN,GMU_ANIM.LINEAR);
	var SIZE_EASE=Battle_GetTurnInfo(BATTLE_TURN.BOARD_RESET_SIZE_EASE,GMU_ANIM.OUT);
