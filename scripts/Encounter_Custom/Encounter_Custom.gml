function Encounter_Custom() {
	...
	Encounter_Set(ENEMY_ID.SIMPLE	,-1,battle_enemy_simple,-1,"* You encountered the test& monster!",bgm_battle);
	Encounter_Set(ENEMY_ID.EX		,-1,battle_enemy_ex,-1,"* You encountered the test&  monster!",bgm_battle);
}
